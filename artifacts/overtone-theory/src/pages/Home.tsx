    ...
    <div className="bg-clean-white overflow-x-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 flex flex-col items-center">
          <FadeIn>
            <h1 className="text-[32px] sm:text-[40px] md:text-[56px] lg:text-[64px] font-bold text-clean-white mb-8 leading-[1.1]">
              Your art is already within you.<br />
              <span className="text-signal-gold">I'll help you find it.</span>
            </h1>
          </FadeIn>
        ...
        <div className="max-w-[720px] mx-auto">
          ...
          <FadeIn delay={150}>
            <div className="space-y-6 text-lg md:text-xl font-serif text-clean-white/90">
              <p>In music and physics, an overtone is a frequency that exists naturally above the fundamental note. You don't force an overtone into existence. You create the right conditions — the right vibration, the right resonance — and it appears on its own.</p>
              ...
              <p>The Overtone Theory is a practice I've developed over 15+ years of working with musicians, writers, artists, and creators of all kinds. It combines guided imaginative exercises, meditation, and deep conversation to help you reconnect with the creative energy that's already inside you.</p>
              <p>I don't teach you how to make art. You already know how. I help you get out of your own way so your art can come through clearly.</p>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={300}>
            ...
            <div className="space-y-6 text-lg md:text-xl font-serif text-clean-white/90">
              <p>This isn't a metaphor. Your brain converts chemical energy into electrical signals. Your muscles operate on electrical impulse. Your fascia is literally piezoelectric — it generates an electric field as you move. Your body produces and exists within its own electromagnetic field.</p>
              <p>You — the one piloting that meat suit of yours — you are the one making sense of the signals your body receives. Like tuning a radio, you get to choose what frequency you're paying attention to. The antenna doesn't care if it's picking up jazz, static, or silence. It just receives whatever's in the field. You are the choice-maker. You decide what to tune into.</p>
              <p>When you're creatively blocked, you're tuned to the wrong station. The signal is still there. You've just lost the frequency.</p>
      ...
      <section id="process" className="py-24 md:py-32 px-6 bg-clean-white">
        <div className="max-w-4xl mx-auto">
          <FadeIn>
            <h2 className="text-3xl md:text-4xl font-bold mb-16 text-abyss text-center">The 4 Steps</h2>
          </FadeIn>
